+++
title = "a-new-kde"
description = "Things in this file are not organized properly, so maybe I will cover it in the blog site :)"
+++
...
## Do no disturb in fullscreen

By default, it will be enabled. To disable it, go to system settigns, notifications, and uncheck the option.
