+++
title = "Windows-container-with-podman"
description = "```Dockerfile"
+++

# Windows container with podman
...
services:
  windows:
    ...
    environment:
      ...
      USERNAME: "sharafat" # Edit here to set a custom Windows username. The default is 'MyWindowsUser'.
